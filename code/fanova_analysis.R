...
p3<-ggplot(data=smoothdf, aes(x=argvals, y=value, group=variable, col=group))+geom_line()+scale_color_manual(labels = c("burned", "unburned"), values=c('darkgrey','lightgreen'))+
...
smooth_plot<-ggplot(data=smoothdf, aes(x=argvals, y=value, group=variable, col=group))+geom_line()+scale_color_manual(labels = c("burned", "unburned"), values=c('black','lightgreen'))+
...
fanova<-ggplot()+geom_line(data=resdflong, aes(x=as_date(argvals, origin = "2018-04-01"), y=value, group=variable), colour="darkgray", alpha = 0.2)+
...
fanova2<-ggplot()+geom_line(data=resdflong, aes(x=argvals, y=value, group=variable), colour="darkgray", alpha = 0.2)+
